...
geometry semantic SHA256: `0a772234a46afad14eb4af0999294020bb0fb8974ca0b68f3ccd780fa057db51`
...
|---|---|---|---:|---:|---:|---|---|
| lf_hip_min | lf_hip_joint | min | -46.012 | -42.803 | -3.209 | DISAGREES | - |
...
| lf_upper_leg_max | lf_upper_leg_joint | max | +121.875 | +122.607 | -0.732 | AGREES | cross_branch @ +73.284 deg; precedes=True |
| lf_lower_leg_min | lf_lower_leg_joint | min | -92.074 | -91.846 | -0.229 | AGREES | same_branch @ -84.274 deg; precedes=True |
