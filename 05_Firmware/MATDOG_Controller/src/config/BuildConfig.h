...
// reply + DALY KEY read result + IMU block + BMS block = 2588 B; 2395 B
// before the KEY probe), so replies are expected complete while a host
// drains the port - best effort, see VALIDATION.md § G3.1 and § DALY KEY.
